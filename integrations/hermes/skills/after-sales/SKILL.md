---
name: after-sales
description: Use when managing post-purchase experience, building customer loyalty, or increasing repeat purchases
version: 1.0.0
author: The Agency
metadata:
  hermes:
...
**Before** (transactional, no after-sales):
❌ "Sell, disappear, ignore customer"
❌ "No onboarding, customer confused how to use product"
❌ "Slow or no response to questions/issues"
❌ "No follow-up, never check if customer satisfied"
❌ "One-time buyers only, no repeat purchases"
❌ "Negative reviews, bad word-of-mouth"

**After** (relational, exceptional after-sales):
✅ "Sell, onboard, support, nurture"
✅ "Clear onboarding, customer knows exactly how to get results"
✅ "Fast, helpful responses to questions/issues"
✅ "Regular follow-up, ensure satisfaction, offer help"
✅ "Repeat buyers, high retention, increased CLV"
✅ "Positive reviews, referrals, advocates"
...
**Poor response**:
❌ "Sorry about that. Send it back and we'll send a replacement."
(Customer has to do work, feels burdened)

**Good response**:
✅ "Oh no, I'm so sorry your product arrived damaged! 😔

That's completely unacceptable. Here's what I'll do:
1. Express replacement shipping to you TODAY (no need to return damaged one)
2. You should receive it by [date]
3. I've also added a 15% discount code for next order (sorry for the trouble!)
...
**Questions to Ask**:
1. What were the top 3 customer complaints this month?
2. How can we prevent those complaints?
3. What's our review score? Is it improving?
4. What's our repeat purchase rate? How to increase?
5. Which customers need extra attention (had issues, big spenders)?
6. What after-sales touchpoints can we improve or add?
...
**Day 1**: Welcome email + usage guide
**Day 7**: "How's your skin reacting? Tips for best results"
**Day 14**: "Are you seeing results yet? Here's what to expect"
**Day 30**: "Reorder reminder: 15% off your next purchase"
...
**NEXT STEPS**:
1. Audit current after-sales: What happens after customer buys? (map journey)
2. Design onboarding system: Welcome message, getting started guide, proactive check-in
3. Set support standards: Response time承诺, channels, escalation path
4. Create follow-up sequence: Day 3, 7, 14-30 touchpoints with templates
5. Build loyalty program: Rewards for repeat purchases, referrals
6. Implement review system: Ask happy customers for reviews, respond to all
7. Track metrics: Measure satisfaction, retention, CLV, optimize continuously
