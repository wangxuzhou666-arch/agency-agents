...
description: Use when analyzing keywords on Xiaohongshu for content optimization, researching trending topics, discovering search terms, improving content discoverability, or conducting SEO keyword research
version: 1.0.0
author: The Agency
metadata:
  hermes:
...
**4 Keyword Types**:
1. **Short-tail** - Broad, high volume, high competition (e.g., "skincare")
2. **Medium-tail** - More specific, moderate competition (e.g., "dry skin skincare")
3. **Long-tail** - Specific phrases, lower competition (e.g., "winter skincare routine for dry sensitive skin")
4. **Trending** - Time-sensitive buzzwords (e.g., "glass skin trend 2025")
...
**Keyword Wins**:
1. "winter skincare for dry skin" - Ranking #1 (was #15)
   - 12,500 monthly searches
   - 8,200 views (65% CTR)
   - 450 follower conversions

2. "sensitive skin routine" - Ranking #3 (was NR*)
   - 8,000 monthly searches
   - 4,100 views (51% CTR)
   - 280 follower conversions

3. "acne scar treatment" - Ranking #5 (was NR*)
...
**REQUIRED**: Use data-analytics (analyze keyword performance)
**REQUIRED**: Use content-performance-analysis (measure content success)
**REQUIRED**: Use seo-basics (understand SEO fundamentals)
