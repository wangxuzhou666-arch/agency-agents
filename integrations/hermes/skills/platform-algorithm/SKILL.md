...
description: Use when understanding Xiaohongshu's recommendation algorithm, optimizing content reach, or troubleshooting low views
version: 1.0.0
author: The Agency
metadata:
  hermes:
...
**Before** (algorithm-ignorant):
❌ "Post randomly, wonder why some posts succeed and others fail"
❌ "No understanding of reach patterns (appears random)"
❌ "Can't recover from reach drops (don't know what went wrong)"
❌ "Growth feels random, unpredictable"

**After** (algorithm-aware):
✅ "Create content with algorithmic principles (engagement, saves, consistency)"
✅ "Understand reach patterns (know why posts perform as they do)"
✅ "Troubleshoot effectively (diagnose and fix reach issues)"
✅ "Growth feels systematic, predictable"
