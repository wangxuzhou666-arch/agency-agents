---
name: brand-co-branding
description: Use when planning brand collaboration campaigns on Xiaohongshu, seeking partnership opportunities, executing co-branded product launches, managing joint marketing activities, or evaluating partnership success
version: 1.0.0
author: The Agency
metadata:
  hermes:
...
**REQUIRED**: Use KOL-collaboration (amplify partnerships through influencers)
**REQUIRED**: Use content-marketing (create co-branded content strategy)
**REQUIRED**: use brand-operation (manage brand during partnership exposure)
