...
description: Use when managing content creation workflows, organizing publishing schedules, or coordinating team efforts
version: 1.0.0
author: The Agency
metadata:
  hermes:
...
**Before** (chaotic, reactive):
❌ "What should I post today? (decision fatigue, scramble)"
❌ "Create content day-of (stressful, quality suffers)"
❌ "Miss posting days (inconsistent, algorithm penalizes)"
❌ "No plan (random topics, no focus)"
❌ "Burnout from constant creation pressure"

**After** (systematic, proactive):
✅ "Content planned 1-4 weeks in advance"
✅ "Batch-create in dedicated sessions (efficient)"
✅ "Reliable posting schedule (consistent, algorithm rewards)"
✅ "Clear focus and strategy (intentional content)"
✅ "Sustainable, stress-free content creation"
