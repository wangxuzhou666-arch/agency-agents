...
description: Use when planning holiday promotions, launching seasonal products, or capitalizing on trending events
version: 1.0.0
author: The Agency
metadata:
  hermes:
...
**Before** (missed opportunities, reactive):
❌ "Regular content during holidays (missed momentum)"
❌ "No seasonal offers (audience shops elsewhere)"
❌ "Last-minute posts (low reach, low engagement)"
❌ "No campaign coordination (scattered, weak impact)"
❌ "Sales: Regular levels (no seasonal spike)"

**After** (planned campaigns, proactive):
✅ "Seasonal content 2-4 weeks ahead (builds anticipation)"
✅ "Seasonal offers (aligned with holiday/season needs)"
✅ "Coordinated multi-week campaign (builds momentum)"
✅ "Content → Offer → Promotion sequence (strategic)"
✅ "Sales: 3-5x regular levels (seasonal spike)"
...
**After Each Campaign**:
1. **Review report**: What worked, what didn't?
2. **Adjust process**: What will we do differently next time?
3. **Update calendar**: Add next campaign dates
...
**NEXT STEPS**:
1. Map your seasonal calendar: Which 4-8 holidays/seasons matter most for your niche?
2. Choose first campaign: Start with a smaller, lower-stakes campaign (not 11.11 or 12.12 for first try)
3. Plan 3 months out: Set goals, design offers, create content plan
4. Prepare assets: Photos, graphics, copy, landing pages 4-6 weeks in advance
5. Execute and monitor: Launch campaign, track daily, adjust in real-time
6. Analyze results: Review what worked, document learnings, improve next time
7. Build campaign calendar: Schedule all campaigns for year, repeat what works
