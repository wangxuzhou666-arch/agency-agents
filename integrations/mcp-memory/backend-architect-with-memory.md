...
description: Memory-enhanced backend architect — same capabilities as Backend Architect, plus cross-session memory integration for persistent architecture decisions and agent handoffs
color: blue
---
